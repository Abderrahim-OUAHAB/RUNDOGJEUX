...
import { AttackSound,JumpSound ,RunSound} from "./effect.js";
export const states={
    SITTING: 0,
    RUNNING: 1,
    JUMPING: 2,
...
export class Running extends State{
    ...
    enter(){
        ...
        this.game.effects.push(new RunSound(this.game));
    ...
    handleInput(input){
        ...
        }else if(input.includes("Enter") && this.game.specialAttackTime>0){
            this.game.player.setState(states.ROLLING,2);
        }
    }
...
export class Jumping extends State{
    ...
    enter(){
       ...
       this.game.effects.push(new JumpSound(this.game));
...
export class Rolling extends State{
    ...
    enter(){
      this.game.player.frameX=0;
        ...
        this.game.player.maxFrame=6;
        this.game.effects.push(new AttackSound(this.game));
     


    }
    handleInput(input){
       if(this.game.specialAttackTime>0) {
...
export class Diving extends State{
    ...
    handleInput(input){
        ...
        }else if(input.includes('Enter') && this.game.player.onGround() && this.game.specialAttackTime>0){
